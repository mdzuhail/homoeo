                ...
                (function () {
                    ...
                    noUiSlider.create(e, {
                        ...
                        e.noUiSlider.on("update", function (e, a) {
                            a
                                ? (n.innerHTML = Math.round(e[a]))
                                : (t.innerHTML = Math.round(e[a]));
                        });
                                ...
                                tag: function (e) {
                                    ...
                                    try {
                                        return `<tag title='${
                                            ...
                                            e.code
                                                ? `<img onerror="this.style.visibility = 'hidden'" class="w-25px rounded-circle me-2" src='${t}' />`
                                                : ""
                        ...
                        e.addEventListener("click", (t) => {
                            e.classList.contains("active") ||
                                ...
                                s.classList.contains("active")
                                    ...
                                    : d.nextElementSibling.classList.add(
                                          "d-none"
                                      ));
                        });
                    });
                    ...
                    noUiSlider.create(u, {
                        ...
                        u.noUiSlider.on("update", function (e, t) {
                            (m.innerHTML = Math.round(e[t])),
                                t && (m.innerHTML = Math.round(e[t]));
                        }),
                        document
                            .querySelector(
