...
<body id="kt_body" class="safari-mode app-blank">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <a href="{{url('/')}}" class="d-block d-lg-none mx-auto py-20">
                <img alt="Logo" src="images/default.svg" class="theme-light-show h-25px">
                <img alt="Logo" src="images/default-dark.svg" class="theme-dark-show h-25px">
            </a>
            <!--end::Logo-->
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="d-flex flex-stack py-2">
                        ...
                        <div class="m-0">
                            ...
                            <a href="/metronic8/demo60/authentication/layouts/fancy/sign-up.html"
                    ...
                    <div class="py-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            data-kt-redirect-url="{{url('/')}}" action="#">
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Heading-->
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-10">
                                    ...
                                    <!--begin::Link-->
                                    <a href="/metronic8/demo60/authentication/layouts/fancy/reset-password.html"
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="#" class="symbol symbol-circle symbol-45px w-45px bg-light me-3">
                                            <img alt="Logo" src="images/google-icon.svg" class="p-4">
                                        </a>
                                        <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <img alt="Logo" src="images/facebook-3.svg" class="p-4">
                                        </a>
                                        <!--end::Symbol-->

                                        <!--begin::Symbol-->
                                        <a href="#" class="symbol symbol-circle symbol-45px w-45px bg-light">
                                            <img alt="Logo" src="images/apple-black.svg"
                                                class="theme-light-show p-4">
                                            <img alt="Logo" src="images/apple-black-dark.svg"
                    ...
                    <div class="m-0">
                        ...
                        <button class="btn btn-flex btn-link rotate" data-kt-menu-trigger="click"
                            ...
                            <img data-kt-element="current-lang-flag" class="w-25px h-25px rounded-circle me-3"
                                src="images/united-states.svg" alt="">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1" src="images/spain.svg"
                                            alt="">
                                    </span>
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1" src="images/germany.svg"
                                            alt="">
                                    </span>
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1" src="images/japan.svg"
                                            alt="">
                                    </span>
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5" data-kt-lang="French">
                                    <span class="symbol symbol-20px me-4">
                                        <img data-kt-element="lang-flag" class="rounded-1" src="images/france.svg"
                                            alt="">
                                    </span>
            ...
            style="background-image: url('{{ asset('images/bg11.png') }}')">
            </div>
            <!--begin::Body-->
        </div>
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <input class="form-control d-flex align-items-center" value=""
                                            ...
                                            data-kt-flags-path="/metronic8/demo60/assets/media/flags/">
                                        <!--end::Tagify-->
                                    </div>
                                    <!--end::Input group-->
                        ...
                        <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text"
                                            ...
                                            name="top_up_amount" placeholder="" value=""
                                            autocomplete="off">
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div class="row row-cols-1 row-cols-md-2 g-5">
                                                ...
                                                <label
                                                    ...
                                                    <span class="d-block fw-semibold text-start">
                                                        ...
                                                        <span class="text-muted fw-semibold fs-6">
                                                            Top up wallet using cash from one of your saved payment
                                                            options.
                                                        </span>
                                                    </span>
                                                </label>
                                            ...
                                            <div class="col">
                                                <!--begin::Option-->
                                                <input type="radio" class="btn-check" name="currency_type"
                                                    value="crypto" id="kt_radio_buttons_2_option_2">
                                                <label
                                                    class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center h-100"
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="" data-kt-modal-top-up-wallet-option="dollar">
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-semibold mb-2">Select a payment
                                                method</label>
                                            <!--End::Label-->
                                            ...
                                            <div class="row row-cols-1 row-cols-md-2 g-5">
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <input type="radio" class="btn-check" name="payment_methods"
                                                        value="dollar"
                                                        id="kt_modal_top_up_wallet_payment_method_option_0"
                                                        checked="">
                                                    <label
                                                ...
                                                <div class="col">
                                                    <!--begin::Add new card-->
                                                    <a href="/metronic8/demo60/utilities/modals/forms/new-card.html"
                                    ...
                                    <div class="d-none" data-kt-modal-top-up-wallet-option="crypto">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div class="row row-cols-2 row-cols-md-4 g-5">
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <input type="radio" class="btn-check" name="select_coin"
                                                        value="dollar" id="kt_modal_top_up_wallet_coin_option_0"
                                                        checked="">
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100"
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <input type="radio" class="btn-check" name="select_coin"
                                                        value="dollar" id="kt_modal_top_up_wallet_coin_option_1">
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100"
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <input type="radio" class="btn-check" name="select_coin"
                                                        value="dollar" id="kt_modal_top_up_wallet_coin_option_2">
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100"
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <input type="radio" class="btn-check" name="select_coin"
                                                        value="dollar" id="kt_modal_top_up_wallet_coin_option_3">
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100"
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <input type="radio" class="btn-check" name="select_coin"
                                                        value="dollar" id="kt_modal_top_up_wallet_coin_option_4">
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100"
                                                ...
                                                <div class="col">
                                                    <!--begin::Option-->
                                                    <input type="radio" class="btn-check" name="select_coin"
                                                        value="dollar" id="kt_modal_top_up_wallet_coin_option_5">
                                                    <label
                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100"
                                                        for="kt_modal_top_up_wallet_coin_option_5">
                                                        <!--begin::Icon-->
                                                        <img src="images/filecoin.svg" alt=""
                                                            class="w-50px">
                                                        <!--end::Icon-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <input type="password"
                                            class="form-control form-control-lg form-control-solid"
                                            name="top_up_password" placeholder="" value=""
                                            autocomplete="off">
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <!--begin::Actions-->
                                    <div class="d-flex flex-center pb-20">
                                        <button id="kt_modal_top_up_wallet_create_new" type="button"
                                            class="btn btn-lg btn-light me-3" data-kt-element="complete-start">
                                            Top Up Wallet
                                        </button>
    ...
    <!--end::Modal - Create Campaign--> <!--end::Modals-->
