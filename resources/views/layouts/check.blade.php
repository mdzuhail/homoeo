 <!--begin::Modals-->
                                        ...
                                        <div class="mh-300px scroll-y me-n7 pe-7">
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px">
                                                        <img src="images/pdf.svg" alt="icon">
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="images/tif.svg" alt="icon">
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="images/folder-document.svg" alt="icon">
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="images/ai.svg" alt="icon">
                                                    </div>
                                                    <!--end::Avatar-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Tagify-->
                                        <input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/homoeo/demo60/assets/media/flags/">
                                        <!--end::Tagify-->
                                    </div>
                                    <!--end::Input group-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="text-center px-4">
                                        <img src="images/9.png" alt="" class="mww-100 mh-350px">
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                    <img src="images/visa.svg" alt="" class="h-25px">
                                    <img src="images/mastercard.svg" alt="" class="h-25px">
                                    <img src="images/american-express.svg" alt="" class="h-25px">
                                </div>
                                <!--end::Card logos-->
                            </div>
                            <!--end::Input wrapper-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_bidding_form" class="form" action="#">
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <!--begin::Select2-->
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="currency_type" data-placeholder="Select a Currency Type">
                                <option value=""></option>
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <div class="" data-kt-modal-bidding-type="dollar">
                                ...
                                <select name="currency_dollar" aria-label="Select a Currency" data-placeholder="Select a currency.." class="form-select form-select-solid form-select-lg">
                                    <option data-kt-bidding-modal-option-icon="flags/united-states.svg" value="USD" selected="">USD�&nbsp;-�&nbsp;USA dollar</option>
                                    <option data-kt-bidding-modal-option-icon="flags/united-kingdom.svg" value="GBP">GBP�&nbsp;-�&nbsp;British pound</option>
                                    <option data-kt-bidding-modal-option-icon="flags/australia.svg" value="AUD">AUD�&nbsp;-�&nbsp;Australian dollar</option>
                                    <option data-kt-bidding-modal-option-icon="flags/japan.svg" value="JPY">JPY�&nbsp;-�&nbsp;Japanese yen</option>
                                    <option data-kt-bidding-modal-option-icon="flags/sweden.svg" value="SEK">SEK�&nbsp;-�&nbsp;Swedish krona</option>
                                    <option data-kt-bidding-modal-option-icon="flags/canada.svg" value="CAD">CAD�&nbsp;-�&nbsp;Canadian dollar</option>
                                    <option data-kt-bidding-modal-option-icon="flags/switzerland.svg" value="CHF">CHF�&nbsp;-�&nbsp;Swiss franc</option>
                                </select>
                                <!--end::Select2-->
                            </div>
                            <!--end::Dollar type-->
                        ...
                        <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1 ">
                                ...
                                <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 "> Not enough funds in your wallet? <a href="/homoeo/demo60/utilities/modals/wizards/top-up-wallet.html" class="text-bolder">Top up wallet</a>.</div>
                                </div>
                                <!--end::Content-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="images/google-icon.svg" class="h-20px me-3">
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-6.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-1.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-5.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-25.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-9.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-23.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-12.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-13.jpg">
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="images/300-21.jpg">
                                    </div>
                                    <!--end::Avatar-->
                                            ...
                                            <div class="row row-cols-1 row-cols-md-2 g-5">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-start gap-5 h-100" for="kt_modal_top_up_wallet_payment_method_option_0">
                                                        <!--begin::Icon-->
                                                        <img src="images/mastercard.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-start gap-5 h-100" for="kt_modal_top_up_wallet_payment_method_option_1">
                                                        <!--begin::Icon-->
                                                        <img src="images/visa.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                                ...
                                                <div class="col">
                                                    <!--begin::Add new card-->
                                                    <a href="/homoeo/demo60/utilities/modals/forms/new-card.html" class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100">
                                                        <!--begin::Icon-->
                                            ...
                                            <div class="row row-cols-2 row-cols-md-4 g-5">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_0">
                                                        <!--begin::Icon-->
                                                        <img src="images/binance.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_1">
                                                        <!--begin::Icon-->
                                                        <img src="images/bitcoin.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_2">
                                                        <!--begin::Icon-->
                                                        <img src="images/chainlink.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_3">
                                                        <!--begin::Icon-->
                                                        <img src="images/coin.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_4">
                                                        <!--begin::Icon-->
                                                        <img src="images/ethereum.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex flex-column flex-center gap-5 h-100" for="kt_modal_top_up_wallet_coin_option_5">
                                                        <!--begin::Icon-->
                                                        <img src="images/filecoin.svg" alt="" class="w-50px">
                                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-column mb-10">
                                        ...
                                        <div class="d-flex align-items-center gap-5">
                                            ...
                                            <div class="symbol symbol-100px symbol-circle">
                                                <img src="images/300-11.jpg" alt="Secret Image">
                                            </div>
                                            <!--end::Image-->
    ...
    <!--end::Modal - Create Campaign--><!--begin::Modal - Share & Earn-->
                ...
                <div class="modal-body scroll-y pt-0 pb-15">
                    ...
                    <div class="mw-lg-600px mx-auto">
                        ...
                        <div class="mb-10">
                            ...
                            <!--begin::Title-->
                            <div class="d-flex">
                                <input id="kt_share_earn_link_input" type="text" class="form-control form-control-solid me-3 flex-grow-1" name="search" value="https://dheeshan.com/?ref=skitechnology">
                        ...
                        <div class="d-flex">
                            <a href="#" class="btn btn-light w-100">
                                <img alt="Logo" src="images/google.svg" class="h-15px me-3">
                                Import Contacts
                            </a>

                            <a href="#" class="btn btn-light w-100 mx-6">
                                <img alt="Logo" src="images/facebook.svg" class="h-20px me-3">
                                Facebook
                            </a>

                            <a href="#" class="btn btn-light w-100">
                                <img alt="Logo" src="images/twitter.svg" class="h-20px me-3">
                                Twitter
                            </a>
                        </div>
                        <!--end::Actions-->
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="images/1.png" alt="" class="w-100 h-200px h-sm-325px">
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Empty-->
