...
var KTAppEcommerceSaveProduct = (function () {
    const e = () => {
        ...
        // Separate method to initialize Tagify for Known Allergies
        const initializeKnownAllergiesTagify = () => {
            const allergiesInput = document.querySelector("#known_allergies_input");
            if (allergiesInput) {
                new Tagify(allergiesInput, {
                    whitelist: [
                        "dust",
                        "pollen",
                        "peanuts",
    ...
    return {
        init: function () {
            ...
            // Initialize Tagify for Known Allergies separately
            initializeKnownAllergiesTagify();
